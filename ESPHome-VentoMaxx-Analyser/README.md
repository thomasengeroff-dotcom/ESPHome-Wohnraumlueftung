...
Die Konfiguration erfolgt über die Datei [esp_ventomaxx_analyser.yaml](esp_ventomaxx_analyser.yaml).
...
Die detaillierten Messergebnisse und die daraus abgeleiteten Anpassungen für die Haupt-Steuerung sind im Dokument [PWM_ANALYSIS.md](PWM_ANALYSIS.md) dokumentiert.
