...
> [!TIP]
> For the complete technical background and C++ logic implementation, see **[📄 smart-automatic-logic.md](smart-automatic-logic.md)** and **[📄 humidity-management.md](humidity-management.md)**.
...
- **[📄 Automatic Mode Logic Deep Dive](smart-automatic-logic.md)** — Architectural details and C++ state engine.
- **[📄 Humidity Management & HA Sensor Setup](humidity-management.md)** — Absolute humidity formulas and template sensor setup.
