...
[![Language: EN](https://img.shields.io/badge/Language-EN-red.svg)](../en/comfort-and-safety-features.md)
...
> [!TIP]
> Eine vollständige Anleitung zur raumweiten Steuerung über einen zentralen Home Assistant Toggle Helper findest du im **[Home Assistant Urlaubsmodus Setup Guide](vacation-mode-ha-setup.md)**.
